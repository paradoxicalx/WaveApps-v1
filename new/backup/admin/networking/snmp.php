    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse">
        <ul class="nav navbar-nav">
          <li url="networking/sql-proc.php?qs=devices" class="menu-nav info active"><a href="#">Devices</a></li>
          <li url="networking/sql-proc.php?qs=graph"class="menu-nav danger" ><a href="#">Graph</a></li>
        </ul>
        <ul class="nav navbar-nav navbar-right">
          <button class="btn btn-success navbar-btn btn-block btn-new">Add New</button>
        </ul>
      </div>
    </div>
  </nav>
