...
<form class="form-horizontal" id="form-newdevices">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <select id="ip" class="form-control select2x" style="width: 100%;">
        <option value=""></option>
        <?php
          require "../../assets/func/converter.php";
          $query = sqlQuAssoc("SELECT * FROM wavenet.tb_ipmaster WHERE `usage` = 'devices'");
          foreach ($query as $key) :
            $id = $key['id'];
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input id="apipass" name="apipass" type="text" class="form-control" disabled>
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-2"></div>
