    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
          <button class="btn btn-success navbar-btn btn-block btn-new">New Router</button>
        </ul>
      </div>
    </div>
  </nav>
...
Table1Gen("radius/sql-proc.php?qr=all",
...
$('.btn-new').on('click', function() {
  ...
  $('#modal-title-default').text("Add Router");
  $('#modal-body-default').load("radius/new-router.php");
});
$('.selected-edit').on('click', function() {
  $('#modal-default').modal('show');
  $('#modal-title-default').text("Edit Selected");
  $('#modal-body-default').load("radius/edit-router.php");
});
$('.selected-remove').on('click', function() {
  $('#modal-default').modal('show');
  $(".modal-header,.modal-footer").removeClass("error warning success").addClass("warning");
  $(".modal-dialog").removeClass("modal-lg");
  $('#modal-title-default').text("Remove Router");
  $('#modal-body-default').load("radius/remove-router.php");
});
</script>
