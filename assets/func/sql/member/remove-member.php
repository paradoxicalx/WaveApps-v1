    ...
    if ($count > 0) {
      ...
      for ($i = 0; $i < count($id); $i++) {
        ...
        if ($update['status'] == "success") {
          InputLog($_SESSION['name'],"member","Member removed [".$update[0]['data'][0]['name']."]");
          $count++;
        }
      }
      if ($count === count($id)) {
  ...
  if ($_GET['r'] === "remove-data") {
    ...
    if ($data == "Email") {
      for ($i = 0; $i < count($id); $i++) {
        ...
        if ($update['status'] == "success") {
          InputLog($_SESSION['name'],"member","Email data removed [".$update[0]['data'][0]['name']."]");
          $count++;
        }
      }
    }
    if ($data == "Phone") {
      for ($i = 0; $i < count($id); $i++) {
        ...
        if ($update['status'] == "success") {
          InputLog($_SESSION['name'],"member","Phone data removed [".$update[0]['data'][0]['name']."]");
          $count++;
        }
      }
    }
    if ($data == "Address") {
      for ($i = 0; $i < count($id); $i++) {
        ...
        if ($update['status'] == "success") {
          InputLog($_SESSION['name'],"member","Address data removed [".$update[0]['data'][0]['name']."]");
          $count++;
        }
      }
    }
    if ($data == "Location") {
      for ($i = 0; $i < count($id); $i++) {
        ...
        if ($update['status'] == "success") {
          InputLog($_SESSION['name'],"member","Location data removed [".$update[0]['data'][0]['name']."]");
          $count++;
        }
      }
    }
    if ($data == "Notes") {
      for ($i = 0; $i < count($id); $i++) {
        ...
        if ($update['status'] == "success") {
          InputLog($_SESSION['name'],"member","Notes data removed [".$update[0]['data'][0]['name']."]");
          $count++;
        }
      }
    }
